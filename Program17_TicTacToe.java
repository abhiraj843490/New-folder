...
public class Program17_TicTacToe {
    public static void main(String[] args){
        ...
        System.out.println("Hi, "+playerName[1]+" your sign is: 0.");
        System.out.println("==========================");
        
        System.out.println("Current cavas of game is empty.");
        System.out.println("Let us start game now.");
        System.out.println();
        System.out.println("----------------------------");
        
        while(true){
            if(currPlayer==1) sign='X'; else sign='0';
